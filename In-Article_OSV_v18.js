(function () {
  ...
  function requestAds(isMidroll) {
    ...
    req.adTagUrl = waterfall[index] + "&description_url=" + PAGE_URL + "&vid_d=600&vid_t=" + encodeURIComponent(document.title) + "&vid_kw=" + encodeURIComponent("stock market, investing, finance, crude oil price, gold price, rupees, sensex, bse, share market") + "&vpmute=" + getVPMute() + "&correlator=" + Date.now();
